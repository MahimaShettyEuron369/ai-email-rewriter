...
You can see the Subject Prompt section where you can enter any text you want to work on.
...
The app will suggest two alternative outputs.
...
The app will successfully parse them and deliver two rewritten outputs.

You can configure: Tone, Audience, Mail Type, Length, and choose between Rewrite or Grammar Mode.
